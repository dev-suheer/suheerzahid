          ...
          {projects.map((project) => {
            ...
            return (
              <motion.div key={project.title} variants={staggerItem}>
                <Card className="pt-2 group relative h-full overflow-hidden border-border/50 bg-card/50 backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:neon-glow">
                  {/* Gradient accent */}
                  <div
                  ...
                  <CardContent className="relative p-6 pt-3 sm:p-6">
