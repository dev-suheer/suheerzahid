          ...
          <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
            <CardContent className="p-5 sm:p-8 text-center">
              <div className="mb-8 space-y-4">
                <a
                  href="mailto:suheer.work18@gmail.com"
                  className="group inline-flex items-center gap-2 text-sm sm:text-lg font-mono text-primary transition-colors hover:text-foreground"
                >
                  <Mail className="h-5 w-5" />
                  suheer.work18@gmail.com
              ...
              <div className="flex justify-center gap-2 sm:gap-4 flex-wrap">
                ...
                <a
                  ...
                  className={buttonVariants({ variant: "outline", size: "lg" })}
                >
                  <LinkedInIcon className="mr-1 sm:mr-2 h-4 w-4" />
                  LinkedIn
                </a>
                <a
                  ...
                  className={buttonVariants({ variant: "outline", size: "lg" })}
                >
                  <XIcon className="mr-1 sm:mr-2 h-4 w-4" />
                  Twitter
                </a>
              </div>
            </CardContent>
