    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pt-16">
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        <motion.h1
          ...
          className="mb-4 text-4xl font-bold tracking-tight sm:text-7xl"
        >
          Suheer <span className="gradient-text">Zahid</span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="mx-auto mb-10 max-w-2xl text-md text-muted-foreground sm:text-xl"
        >
          Full Stack & React Native Developer with 4+ years turning complex
          ideas into scalable web apps, mobile experiences, and powerful admin
          panels. Deployed and production ready.
