...
export function Experience() {
  return (
    <>
      <section id="experience" className="pt-20 sm:pt-32 px-6">
        <div className="mx-auto max-w-4xl">
          <SectionHeading
            label="// experience"
            title="Where I've Worked"
            description="Not just experience on paper. Experience earned in production."
          />
        </div>
      </section>

      <section className="pb-20 sm:pb-32 px-6 pl-1 sm:px-6">
        <div className="mx-auto max-w-4xl">
